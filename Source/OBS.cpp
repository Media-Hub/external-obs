...
void OBS::SetCameraPosition(int width, int height, int x, int y)
{
    ...
    if (sceneElement)
    {
        ...
        if (sources)
        {
            for (int i = numSources - 1; i >= 0; i--)
            {
                ...
                bool dontStretchImage = ((320 - width) >= 0 && (240 - height) >= 0);
                ...
                if (className.Compare(L"DeviceCapture"))
                {
                    ...
                    if (dontStretchImage)
                    {
                        widthCrop = ((320 - width) * 1.0) / 2;
                        heightCrop = ((240 - height) * 1.0) / 2;
                    ...
                    else
                    {
                        if (takeWidthAsOriginal)
                        {
                            ...
                            heightCrop = ((((expectedHeight - (float)height) * 1.0)) / 2) * ((float)240/expectedHeight);
                        ...
                        else
						{
                            ...
                            widthCrop = ((((expectedWidth - (float)width) * 1.0)) / 2) * ((float)320/expectedWidth);
